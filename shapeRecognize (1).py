#Code heavily adapted from Manutea Huang on github
...
device = cv2.VideoCapture(1)    #Use extrenal camera
scale = 1                       #Size of text
color = (255,0,0)               #Color variable used to change color of text in the display
text = ''                       #Text variable used to write name of color and shape to the display
...
while True:
        ...
        #green
        green_lower_range = np.array([40,70,30])
        green_upper_range = np.array([85,255,255])
        #red range 1
        ...
        #Masks used to display only one of the three colors
        ...
        #Combines each Canny edge detection masks into one edge mask
        ...
        for x in range(0,3):    #from 0 to 2
            ...
            #Manutea Haung algorithm with minor changes to text variales START
            if ret==True:
                #contours
